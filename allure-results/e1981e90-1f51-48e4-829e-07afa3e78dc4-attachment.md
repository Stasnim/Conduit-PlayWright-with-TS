...
Expected: "steeple devotee, leader ◻️"
Received: ""
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByPlaceholder('Short bio about you')
    18 × locator resolved to <textarea rows="8" formcontrolname="bio" placeholder="Short bio about you" class="form-control form-control-lg ng-untouched ng-pristine ng-valid">              </textarea>
       - unexpected value ""
